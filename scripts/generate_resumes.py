...
h1 {{ margin: 0; font-size: 24pt; line-height: 1; letter-spacing: .01em; }} h2 {{ margin: 15px 0 6px; padding-bottom: 3px; border-bottom: 1px solid #075858; color: #075858; font-size: 9.5pt; letter-spacing: .02em; text-transform: uppercase; }}
.target {{ margin: 5px 0 6px; color: #075858; font-size: 11pt; font-weight: bold; }} .contact {{ margin: 0 0 12px; color: #171a20; font-size: 8.5pt; }} a {{ color: #075858; text-decoration: none; }}
.summary {{ margin: 0; font-size: 10pt; line-height: 1.4; }} .skills p {{ margin: 2px 0; }} .skills strong {{ color: #171a20; }}
.role {{ margin: 0 0 8px; break-inside: avoid; }} .role-head {{ display: flex; justify-content: space-between; gap: 16px; line-height: 1.2; }} .role-head span {{ white-space: nowrap; color: #171a20; }} .company {{ margin: 2px 0 2px; color: #171a20; font-style: italic; }} ul {{ margin: 0; padding-left: 17px; }} li {{ margin: 1px 0; }}
.page-break {{ break-before: page; page-break-before: always; }} .project {{ margin: 0 0 6px; }} .project strong {{ color: #075858; }} .footer {{ margin-top: 18px; padding-top: 5px; border-top: 1px solid #171a20; color: #171a20; font-size: 7.5pt; display: flex; justify-content: space-between; }}
</style></head><body>
<header><h1>UDHAYA KUMAR</h1><div class="target">Staff Backend Engineer | Debezium · ClickHouse · Pub/Sub · Real-time CDC</div><div class="contact"><a href="mailto:mail4udhaya@gmail.com">mail4udhaya@gmail.com</a> | +91 7259948358 | <a href="https://udhayakumar.com">udhayakumar.com</a> | <a href="https://linkedin.com/in/udhayakumark">linkedin.com/in/udhayakumark</a> | Salem, Tamil Nadu, India | Remote</div></header>
...
{role("Software Development Lead", "Aug 2018 - Feb 2019", "Friday Media Group | Bengaluru", ("Managed 3–6 engineers across marketplace API development, content ingestion, and data pipeline systems. Coached team on technical depth and ownership.",))}
{role("Senior Software Engineer - I / Software Analyst", "Feb 2014 - Jul 2018", "Scientific Games | Bengaluru", ("Diagnosed and fixed pagination + join cardinality inversion problem in recurring MySQL reporting workload. Query improved: 3+ minutes → <500ms (360x improvement). Built reporting integrations and web services for high-volume gaming platforms.",))}
...
<h2>Technical Depth</h2><div class="skills"><p><strong>Real-Time Data Architecture:</strong> CDC (Debezium, Datastream), Google Pub/Sub, event sourcing, webhook integrations, idempotency patterns, fan-out design</p><p><strong>Databases & Query Optimization:</strong> MySQL (index design, query execution plans, schema design, partitioning), ClickHouse, BigQuery, MongoDB, Redis</p><p><strong>Data Modeling & Analytics:</strong> fact/dimension tables, slowly-changing dimensions, identity resolution, multi-source data consolidation</p><p><strong>Backend Systems:</strong> Node.js, TypeScript, PHP; microservices architecture; REST APIs; async patterns</p><p><strong>Infrastructure & Operations:</strong> GCP, GKE, Docker, Kubernetes, Google Cloud Monitoring; incident response, post-mortems</p><p><strong>Team Leadership:</strong> hiring, mentorship, async-first remote management, code review culture</p></div>
