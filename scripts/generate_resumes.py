...
h1 {{ margin: 0; font-size: 24pt; line-height: 1; letter-spacing: .01em; }} h2 {{ margin: 15px 0 6px; padding-bottom: 3px; border-bottom: 1px solid #7aa8a4; color: #075858; font-size: 9.5pt; letter-spacing: .02em; text-transform: uppercase; }}
