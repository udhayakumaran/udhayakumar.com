...
const experience = [
  {
    ...
    company: "ConvertCart",
    focus: "Real-time data pipelines, production incidents, customer communication, recommendation engine",
    years: "2020 — 2021",
    tech: ["MySQL", "Debezium", "Pub/Sub", "Webhooks", "Datastream", "GKE"],
    bullets: [
      <>Diagnosed fragile cron-sync system (normalize-on-ingest locked all retroactive changes to full resyncs), redesigned to raw-source storage eliminating expensive resync friction. Communicated migration strategy to merchant teams.</>,
      <>Replaced batch sync with real-time pipelines: native webhooks for Shopify and BigCommerce, custom implementations for WooCommerce and Magento 2 (no native webhook support). Built reference implementations for each platform.</>,
      <>Stopped production crisis: <strong className="text-accent bg-accent-wash px-1 py-0.5 rounded font-label-mono-sm text-label-mono-sm">50M-row CDC snapshot consumed 60% CPU, blocked writes</strong>. Diagnosed root cause (table-level snapshots at scale), recovered safely via Datastream, fixed via incremental table-level migration with production-scale testing. Partnered with affected merchants on recovery plan.</>,
      <>Initiated recommendation engine (Manual → Automated → Smart trust ladder). Validated <strong className="text-ink bg-panel-2 px-1 py-0.5 rounded font-label-mono-sm text-label-mono-sm">80%+ adoption on Smart tier</strong>. Guided merchants through feature onboarding and configuration.</>,
    ],
  },
  {
    role: "Senior Product Development Lead",
    company: "ConvertCart",
    focus: "Data platform architecture, customer implementation, identity resolution, segmentation, recommendations",
    years: "2021 — 2026",
    tech: ["MySQL", "Debezium", "Pub/Sub", "MongoDB", "BigQuery", "ClickHouse", "Redis", "GKE"],
    bullets: [
      <>Partnered directly with <strong className="text-ink bg-panel-2 px-1 py-0.5 rounded font-label-mono-sm text-label-mono-sm">200+ merchant engineering teams</strong> to architect scalable customer and order data systems spanning five commerce platforms. Conducted technical deep-dives on custom requirements, integration patterns, and production deployment strategies.</>,
      <>Designed multi-source BigQuery customer schema consolidating Shopify, BigCommerce, WooCommerce, Magento plus click-tracking. Implemented <strong className="text-ink bg-panel-2 px-1 py-0.5 rounded font-label-mono-sm text-label-mono-sm">deterministic identity resolution</strong> across anonymous sessions and known customers. Guided merchants through onboarding and troubleshooting.</>,
      <>Built SQL query builder enabling non-technical CSMs to create segments with merchant input. Reached <strong className="text-ink bg-panel-2 px-1 py-0.5 rounded font-label-mono-sm text-label-mono-sm">1,000+ active segments in 6 months</strong>, enabled merchants to self-serve (eliminated 40-request engineering backlog).</>,
      <>Scaled recommendation engine to <strong className="text-ink bg-panel-2 px-1 py-0.5 rounded font-label-mono-sm text-label-mono-sm">80% merchant adoption</strong> at <strong className="text-sage bg-sage-wash border border-sage px-1 py-0.5 rounded font-label-mono-sm text-label-mono-sm">200ms p99</strong> across five regions. Provided architecture guidance and migration support to production customers.</>,
      ...
      <>Architected <strong className="text-ink bg-panel-2 px-1 py-0.5 rounded font-label-mono-sm text-label-mono-sm">50+ microservices</strong> platform while growing team from <strong className="text-ink bg-panel-2 px-1 py-0.5 rounded font-label-mono-sm text-label-mono-sm">4 to 7 engineers</strong>. Owned architecture reviews and technical mentoring for customer-facing systems.</>,
    ],
  },
  {
    role: "Backend Consultant",
    company: "Independent Consultant",
    focus: "Custom client requirements, backend architecture, direct technical engagement",
    years: "2019 — 2020",
    tech: [],
    bullets: [
      <>Partnered directly with clients on custom requirements and bespoke backend solutions. Conducted technical design sessions, built prototypes, and guided implementation from architecture to production deployment.</>,
    ],
  },
  {
